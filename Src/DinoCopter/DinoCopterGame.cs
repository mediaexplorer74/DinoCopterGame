...
namespace GameManager
{
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            switch (this.currentGameState)
            {
                case Game1.GameState.MainMenu:
                    ...
                    this.btnCreateProfile = new Button(this.Content.Load<Texture2D>("480x800/button"),//("CreateProfileOff"),
                        new Vector2(100f, 300f), "CreateProfileOff", "CreateProfileOn", 300, 100);

                    this.btnStartGame = new Button(this.Content.Load<Texture2D>("480x800/button"),//("ContinueOff"),
                        new Vector2(100f, 500f), "ContinueOff", "ContinueOn", 200, 100);

                    this.btnExit = new Button(this.Content.Load<Texture2D>("480x800/button"),//("ExitOff"),
            ...
            switch (this.currentGameState)
            {
                ...
                case Game1.GameState.MainMenu:
                    ...
                    if (this.btnStartGame.isClicked)
                    {
                        ...
                        Debug.WriteLine("[i] btnStartGame is clicked");
                    }

                    if (this.btnExit.isClicked)
                    {
                        //this.Exit();
                        Debug.WriteLine("[i] btnExit is clicked");
                    }
                ...
                case Game1.GameState.Playing:
                    if (!this.paused)
                    {
                        ...
                        {
                            connection.OpenCon();
                            this.player = new character();//connection.GetAllRows<character>().Last<character>();
                    ...
                    {
                        this.IsMouseVisible = true;
                        this.btnContinue = new Button(this.Content.Load<Texture2D>("480x800/button"),//("ContinueOff"),
                            new Vector2(700f, 300f), "ContinueOff", "ContinueOn", 200, 100);

                        this.btnSave = new Button(this.Content.Load<Texture2D>("480x800/button"),//("SaveOff"),
                            new Vector2(700f, 400f), "SaveOff", "SaveOn", 200, 100);

                        this.btnMainMenu = new Button(this.Content.Load<Texture2D>("480x800/button"),//("MainMenuOff"),
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            this.spriteBatch.Begin(SpriteSortMode.Immediate, null, null, null, null, null, 
            ...
            {
                case Game1.GameState.MainMenu:
                    this.spriteBatch.Draw(this.Content.Load<Texture2D>("480x800/bg")/*("MainMenu")*/,
