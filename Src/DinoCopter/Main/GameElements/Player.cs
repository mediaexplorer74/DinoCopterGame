  ...
  internal class Player : Sprite
  {
    ...
    public override void OnCollision(Sprite s)
    {
      ...
      if (s.GetTypeId() != -2 && s.GetTypeId() != 10)
        return;
      Collision collision = Collision.CollisionRectangleRectangle(this.GetPos(), 
          this.GetPos() + this.GetSize(), s.GetPos(), s.GetPos() + s.GetSize(),
    ...
    public override void Render(SpriteBatch spriteBatch)
    {
      ...
      for (int index = 0; index < 10; ++index)
      {
        ...
        public bool AcceptMorePassengers()
        {
            return this.PassengersIn < this.MaxPassengers;
        }
    }
}
